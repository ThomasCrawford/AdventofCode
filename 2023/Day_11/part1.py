...
for x_expand in where_to_expand_x:
	star_locations = [[star[0],star[1]+1] if star[1]>x_expand else star for star in star_locations]
for y_expand in where_to_expand_y:
	star_locations = [[star[0]+1,star[1]] if star[0]>y_expand else star for star in star_locations]
